...
const ExpandableList: React.FC<Props> = ({
	...
	// per-row suppression — confirmed against the installed package's data-table.js), so a
	// variant that wants Carbon parity has to hide it itself (see ComposedCell.css). See
	// docs/migration/operate-dashboard-ds-gaps.md. The pagination skeletons are kept as
	// siblings (not table rows) precisely to avoid picking up that same always-on toggle.
